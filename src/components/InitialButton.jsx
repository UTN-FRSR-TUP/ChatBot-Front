...
import  Chatbot  from "./Chatbot";
 ...
 export const InitialButton = ({botImg, botName, colorPrimario, colorSecundario, welcomeMessage}) => {
	...
	return (
		<>
			<div className="position fixed h-100">
				...
				>
					{showChat && <Chatbot botImg={botImg} botName={botName} colorPrimario={colorPrimario} colorSecundario={colorSecundario} sendMessage={handleSendMessage}  widthImg={widthImg} listMessage={listMessage} setListMessage={setListMessage} />}
